...
export default function SatoriIntelligence() {
  ...
  useEffect(() => {
    ...
    return (
        <section className="pb-10 pt-32 text-white w-full overflow-hidden">
            <div className="max-w-[1440px] mx-auto px-10">
                {/* Header Section */}
                <div className="flex flex-col items-center mb-14 md:mb-24 text-center">
                ...
                <div className="relative group">
                    ...
                    <div className="flex justify-end gap-3  md:mt-12 pr-4">
                        <button
                            onClick={prev}
